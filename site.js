...
(function () {
  ...
  var header =
    ...
    '<a class="logo" href="index.html"><img src="logo.png" alt="OpenToday" style="width:30px;height:30px;display:block;" />' +
  ...
  var footer =
    ...
    '<div class="foot-col"><a class="logo" href="index.html"><img src="logo.png" alt="OpenToday" style="width:30px;height:30px;display:block;" /> <span class="logo-name">OpenToday</span></a>' +
